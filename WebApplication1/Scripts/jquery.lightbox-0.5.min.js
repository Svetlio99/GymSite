 ...
 */
(function(jQuery){jQuery.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'modules/mod_hot_lightbox/images/lightbox-ico-loading.gif',imageBtnPrev:'modules/mod_hot_lightbox/images/lightbox-btn-prev.gif',imageBtnNext:'modules/mod_hot_lightbox/images/lightbox-btn-next.gif',imageBtnClose:'modules/mod_hot_lightbox/images/lightbox-btn-close.gif',imageBlank:'modules/mod_hot_lightbox/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
